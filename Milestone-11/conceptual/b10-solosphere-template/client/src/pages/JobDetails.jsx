...
const JobDetails = () => {
  ...
  const handleSubmitForm = async (e) => {
    ...
    //! Deadline crossed warning------------
    if (compareAsc(new Date(), new Date(deadline)) === 1) {
      return toast.error("Deadline Crossed , bidding forbidden");
    }
    //! max price validation--------------
    if (price > max_price)
      return toast.error("Offer less or at least ", max_price);
    //! user validation (recruiter)
    ...
    <div className="flex flex-col md:flex-row justify-around gap-5  items-center min-h-[calc(100vh-306px)] md:max-w-screen-xl mx-auto ">
      ...
      <div className="flex-1  px-4 py-7 bg-white rounded-md shadow-md md:min-h-[350px]">
        <div className="flex items-center justify-between">
          ...
          Deadline: {job?.deadline ? format(new Date(job?.deadline), "P") : ""}
          </span>
